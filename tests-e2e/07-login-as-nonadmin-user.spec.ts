...
test.describe('Non-Admin User: Login and Logout', () => {

    test('TC-007: Regular user can log in and then log out', async ({ page }) => {
        ...
        await test.step('Log in with correct standard user credentials (test/test)', async () => {
            await page.locator('[name="login"]').fill('test');
            await page.locator('[name="pass"]').fill('test');
        ...
        // --- Step 4: Logout ---
        await test.step('Execute Logout by clicking "Logout"', async () => {
